...
div#content {margin-left:auto; margin-right:auto; clear:both; height:auto; width:100%; float:none; text-align:left;}
</style>
...
if ($stream = fopen('main-main.idx', 'r')) {
	while (!feof($stream)) {
		$line = fgets($stream);
		if ($line !== false) {
